...
ShaderColorLightFog::ShaderColorLightFog(ID3D11Device* dev)
	: ShaderBase(dev, L"../Assets/Shaders/ColorLightFog.hlsl")
{
...
ShaderColorLightFog::~ShaderColorLightFog()
{
...
void ShaderColorLightFog::SendCamMatrices(const Matrix& view, const Matrix& proj)
{
...
void ShaderColorLightFog::SetDirectionalLightParameters(const Vect& dir, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightFog::SetPointLightParameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightFog::SetSpotLightParameters(const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightFog::SendLightParameters(const Vect& eyepos)
{
	Data_LightParams dl;
...
void ShaderColorLightFog::SendWorldAndMaterial(const Matrix& world, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightFog::SetFogParameters(float _FogStart, float _FogRange, Vect _FogColor)
{
	//Fog_Parameters fp;
	//fp.FogStart = _FogStart;
	//fp.FogRange = _FogRange;
	//fp.FogColor = _FogColor;
	//
...
void ShaderColorLightFog::SendFogParameters()
{
	Fog_Parameters fp;
	fp = fogParams;
...
void ShaderColorLightFog::RemoveFog()
{
	this->SetFogParameters(DefaultFogStart, DefaultFogRange, DefaultFogColor);
}

void ShaderColorLightFog::SetToContext(ID3D11DeviceContext* devcon)
{
